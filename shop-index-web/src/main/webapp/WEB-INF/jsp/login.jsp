...
<body>
	...
	<div class="login_main clear">
    	...
    	<span>您还未登录</span>
    	<a href="/registerIndex.action">免费注册</a>
    </div>
	...
	<div class="footer">
		...
		<p>
			北京GODV电子商务有限公司<br> 北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© GODV商城
			e3mall.cn 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
	...
	var LOGIN = {
			...
			doLogin:function() {
				$.post("/user/login.action", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
