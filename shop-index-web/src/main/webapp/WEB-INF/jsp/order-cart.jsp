...
<div class="orderMain">
<form id="orderForm" class="hide" action="/order/create.action" method="post">
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>GODV速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
  ...
  <div class="backToCart"><a style=" text-decoration:underline;" target="" href="/cart/cart.action">返回修改购物车</a></div>
